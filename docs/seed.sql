...
('monsoon-picninic-hungama', 'offer', 'Monsoon Picnic Hungama', '/offers/banner4.png', 620, 690, 'Monsoon Special', '🎟️ Waterpark + Amusement + Adventure (3 Parks = 1 Ticket)', '["Waterpark access", "Adventure park", "Amusement park", "Safari", "Agro activities"]', 6, '🎉 MONSOON PICNIC, HUNGAMA SHURU', '["Waterpark entry", "Adventure park access"]', '["Valid on selected dates"]', NULL, '[{"id":"regular","label":"Per Person","price":690}]', '👉 Book Monsoon Picnic', '⏳ Limited Period Special'),
