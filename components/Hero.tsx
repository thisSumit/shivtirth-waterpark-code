...
const Hero: React.FC<HeroProps> = ({ initialData }) => {
  ...
  const attractions = [
    ...
    { name: "Agro Park", href: "/other-activities#agro-park" },
    { name: "Helicopter Ride", href: "/other-activities#air-tourism" },
    { name: "Accommodation", href: "/accommodation" },
    { name: "Destination Wedding", href: "/other-activities#destination-wedding" },
    { name: "Corporate Events", href: "/other-activities#corporate-events" },
    { name: "Festival Celebrations", href: "/other-activities#festive-celebrations" },
    { name: "Birthday Events", href: "/other-activities#birthday-events" },
