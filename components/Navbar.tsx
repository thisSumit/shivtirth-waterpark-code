...
const defaultParksDropdownItems: ActivityItem[] = [
  ...
  { name: "Dining", id: getParkSectionId("Dining") },
  {
    ...
    id: getParkSectionId("Corporate Events"),
  },
  {
    name: "Birthday Parties",
    id: getParkSectionId("Birthday Parties"),
  },
  {
    name: "Festive Celebrations",
    id: getParkSectionId("Festive Celebrations"),
  },
  {
    name: "Event Planning",
    id: getParkSectionId("Event Planning"),
  },
];
        ...
        <div className="max-w-8xl mx-auto px-3 xl:px-4">
          <div className="relative z-[1000] flex items-center justify-between h-20">
            ...
            <Link
              ...
              className="shrink-0 px-1 xl:px-2"
            >
              <Image
                src="/logo.png"
