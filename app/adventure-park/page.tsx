    ...
    <main id="about-park" className="bg-gradient-to-b from-emerald-950 via-slate-900 to-emerald-950 text-slate-100">
      ...
      <section className="mx-auto max-w-6xl px-4 pt-6">
        <ScrollReveal direction="up" delay={0.2}>
          <div className="grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl bg-white/95 text-[#288382] p-5 shadow-lg border border-emerald-100">
      ...
      <section className="mx-auto max-w-6xl px-4 py-6 pb-10">
        <ScrollReveal direction="up" delay={0.25}>
          <div className="rounded-2xl bg-white/95 text-[#288382] p-5 md:p-6 shadow-lg border border-emerald-100">
            <h3 className="text-lg md:text-xl font-bold text-[#288382] font-times mb-3" style={{ fontFamily: "'Times New Roman', Times, Georgia, serif" }}>
