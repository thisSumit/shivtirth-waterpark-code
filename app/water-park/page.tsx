    ...
    <main id="about-park" className="bg-gradient-to-b from-cyan-900 via-slate-900 to-cyan-950 text-slate-100">
                ...
                <ScrollReveal key={idx} direction="up" delay={0.15 * (idx % 2)} duration={0.5}>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 items-center bg-black/25 backdrop-blur-md p-4 rounded-2xl border border-cyan-400/20">
                    <div className={`order-1 ${idx % 2 === 1 ? 'md:order-2' : ''}`}>
                      <div className="relative w-full aspect-[4/3] rounded-xl overflow-hidden shadow-md">
                        {videoSrc ? (
                          ...
                          <Image
                            src={slide.image || '/adishakti-waterfall.jpg'}
                            alt={slide.title}
                            fill
                    ...
                    <div className={`order-2 ${idx % 2 === 1 ? 'md:order-1' : ''}`}>
                      ...
                      <p className="text-sm text-cyan-50">{slide.description}</p>
                    </div>
                  </div>
                </ScrollReveal>
              );
      ...
      <section className="mx-auto max-w-6xl px-4 pt-6">
        <ScrollReveal direction="up" delay={0.2}>
          <div className="grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl bg-white/95 text-[#288382] p-5 shadow-lg border border-cyan-100">
      ...
      <section className="mx-auto max-w-6xl px-4 py-6 pb-10">
        <ScrollReveal direction="up" delay={0.25}>
          <div className="rounded-2xl bg-white/95 text-[#288382] p-5 md:p-6 shadow-lg border border-cyan-100">
            <h3 className="text-lg md:text-xl font-bold text-[#288382] font-times mb-3" style={{ fontFamily: "'Times New Roman', Times, Georgia, serif" }}>
